...
<main class="flex flex-col flex-1 p-4">
    <section id="introPage" class="grid grid-cols-1 lg:grid-cols-2 gap-10 py-8 sm:py-14">
        <div class="flex flex-col lg:justify-center text-center lg:text-left gap-6 md:gap-8 lg:gap-10">
            <h2 class="font-semibold text-4xl sm:text-5xl md:text-6xl">
                Hi! I'm Leong <span class="poppins text-violet-400">Xin Nan</span> <br/>Full Stack <span class="poppins text-violet-400">Developer</span>
            </h2>
            <p class="text-base sm:text-lg md:text-xl">
                My <span class="text-violet-400">favourite tech</span> include Javascript (NEXT.JS or Sveltekit), TailwindCSS, Node.js + Express.js & PostgreSQL or Firebase/Firestore!
            </p>
            <a href="https://www.linkedin.com/in/leongxinnan/" target="_blank" class="blueShadow mx-auto lg:mr-auto lg:ml-0 text-base sm:text-lg md:text-xl poppins relative overflow-hidden px-6 py-3 group rounded-full bg-white text-slate-950 cursor-pointer">
    ...
    <section id="projects" class="py-20 lg:py-22 flex flex-col gap-24">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-10">
            <Step step={steps[0]}>
                <p class="">
                    Alex Store is a merchandising store created with 
    ...
    <section id="about" class="py-20 pt-10 lg:pt-16 lg:py-32 flex flex-col gap-16 sm:gap-20 md:gap-24 relative">
        ...
        <div class="flex flex-col gap-20 w-full mx-auto max-w-[800px]">
            ...
            <div class="flex gap-6 sm:gap-8">
                <p class="poppins text-4xl sm:text-5xl md:text-6xl text-slate-500 front-semibold">
                    0{index+1}
                </p>
        ...
        <h5 class="text-2xl sm:text-3xl font-semibold text-center poppins">The <span class="poppins text-violet-400">Complete</span> Package</h5>
        <div class="flex flex-col overflow-x-scroll gap-10 max-w-[800px] mx-auto w-full">
            <table class="bg-white text-slate-700 rounded text-center">
                <thead class="border-b boder-solid border-slate-200">
                    <tr class="">
                        <th/>
        ...
        <div class="mx-auto -mt-12 italic sm:hidden opacity-50">
            <p class="">Scroll to see more &rarr;</p>
        </div>
